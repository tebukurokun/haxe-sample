...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 29 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 38 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
		int min = 0;
		//line 39 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
		int max = length;
		...
		while (( min < max ))
		{
			...
			//line 43 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
			int classify = hash.compareTo(hashs[mid]);
			//line 44 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 45 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
				max = mid;
			}
			else
			{
				...
				{
					//line 49 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
					return mid;
				}
		...
		//line 53 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
		return  ~ (min) ;
	}
	...
	{
		//line 57 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 103 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 106 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
		double[] a1 = a;
		//line 106 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
		int capacity = a1.length;
		//line 106 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
	...
	{
		//line 109 "/usr/local/lib/haxe/std/java/internal/FieldLookup.hx"
