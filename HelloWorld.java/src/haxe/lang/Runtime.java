...
public class Runtime
{
	...
	static
	{
		//line 60 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 125 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 125 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return false;
	...
	{
		//line 136 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 136 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return ((long) (0) );
	...
	{
		//line 161 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 152 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( obj instanceof java.lang.Number )) 
		{
			//line 153 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			java.lang.Number n = ((java.lang.Number) (obj) );
			//line 154 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return ( n.doubleValue() == n.intValue() );
		}
		else
		{
			//line 156 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return false;
		}
	...
	{
		//line 547 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( obj == null )) 
		{
			//line 548 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
		}
		
		//line 550 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( ( ( obj instanceof java.lang.Number ) &&  ! (( obj instanceof java.lang.Integer ))  ) && haxe.lang.Runtime.isInt(((java.lang.Number) (obj) )) )) 
		{
			//line 551 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return java.lang.Integer.toString(((int) (haxe.lang.Runtime.toInt(obj)) ));
		}
		
		//line 552 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		return obj.toString();
	}
	...
	{
		//line 556 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( v == v )) 
		{
			//line 556 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
	...
	{
		//line 560 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 560 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return 0;
	...
	{
		//line 564 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 564 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return 0.0;
	...
	{
		//line 568 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( n == null )) 
		{
			//line 568 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return ((long) (0.0) );
	...
	{
		//line 572 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 572 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 580 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 580 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 584 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 584 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 588 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 588 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
	...
	{
		//line 592 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
		if (( num == null )) 
		{
			//line 592 "/usr/local/lib/haxe/std/java/internal/Runtime.hx"
			return null;
